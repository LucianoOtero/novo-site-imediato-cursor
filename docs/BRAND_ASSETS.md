...
- **Correção de centralização (2026-07-12)**: o recorte original (`viewBox="150 150 1550 1550"`) só cortava a área onde ficava o texto "IMEDIATO"/"SEGUROS", sem recentralizar o ícone dentro do novo quadrado — o "M" ficava colado na parte de cima, com um vão vazio grande abaixo (achado do cliente, confirmado renderizando o SVG com `sharp` e medindo a bounding box real do ícone: x 336–1664, y 286–1208 dentro do arquivo original). Corrigido para `viewBox="200 -53 1600 1600"` — mesma proporção quadrada, mas com o ícone de fato centralizado (margens de ~136px nas laterais e ~339px em cima/baixo, proporcionais à forma mais larga que alta do "M"). Validado visualmente em 500×500 e no tamanho real de favicon (180×180).
