...
*Documentação oficial completa — Partes I, II, III & IV (63 seções). Compatível com Next.js 15 · TypeScript · Tailwind CSS 4 · shadcn/ui · Framer Motion · Cursor (Claude Opus 4.1). Iniciar pela seção 63.*
