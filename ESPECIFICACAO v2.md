...
### 55.2 Exemplo preenchido (valores observados — confirmar antes de produção)
```ts
export const company: CompanyConfig = {
  legalName: 'Imediato Corretora de Seguros',          // A CONFIRMAR (razão social exata)
  tradeName: 'Imediato Seguros',
  cnpj: '45.998.165/0001-32',
  susep: '252174522',
  address: { street:'Rua Barão de Itapetininga', number:'125', floor:'6º andar',
    district:'Centro', city:'São Paulo', state:'SP',
    zipCode:'01042-001', country:'BR' },
  contact: {
    phone:'+551132301422', phoneDisplay:'(11) 3230-1422',
    whatsapp:'5511932301422',   // A CONFIRMAR (nº de WhatsApp correto/E.164)
    whatsappDisplay:'(11) 3230-1422',
    emergencyPhone:'+5511953288466', ombudsmanPhone:'+5511976687668',
    email:'contato@imediatoseguros.com.br' },
  business: { yearsExperience:25, insurersCount:16,   // 25–35 anos citados; confirmar
    googleRating:4.8, googleReviewsCount:2000, satisfactionRate:96 },
  legalUrls: { privacyPolicy:'/politica-de-privacidade', terms:'/termos',
    fraudAlert:'/alerta-de-fraude' },
  social: { /* A CONFIRMAR: instagram, facebook, linkedin */ },
}
```

> **A confirmar antes de produção:** razão social exata, nº de WhatsApp oficial (o site atual usa `#`), anos de experiência (hero diz 25; rodapé diz 35+), perfis sociais.
>
> **Regra obrigatória:** nenhum dado institucional/regulatório/comercial recorrente pode aparecer diretamente em JSX. Tudo vem de `lib/company.ts` ou config tipada. Lint/PR review rejeita strings de telefone, CNPJ, SUSEP ou preço em componentes.
...
|---|---|---|---|---|---|
| Razão social exata | "Imediato Corretora de Seguros" | rodapé site | ☐ A CONFIRMAR | Sócio/Jurídico | company.legalName, Schema, footer |
...
| E-mail fallback de leads | — | — | ☐ A DEFINIR | TI/Comercial | LEAD_FALLBACK_EMAIL |
...
| Redes sociais oficiais | — | — | ☐ A CONFIRMAR | Marketing | company.social, sameAs |
| URL Google Business Profile | — | — | ☐ | Marketing | sameAs, /reputacao |
| Link de avaliações Google | — | — | ☐ | Marketing | /reputacao, Testimonials |
